      ...
      <Contents>
        <div className="contents__wrap">
          <div className="content content__1">
            <div className="content__pin right"></div>
          ...
          <div className="content content__2">      
            ...
            <div className="content__pin left">
            </div>
            <div className="content__comp">
          ...
          <div className="content content__4">
            <span className="content__title"><span className="title--italic">SuperApp</span>기술 구성도</span>
            <div className="content__pin left"></div>
            <div className="content__text--wrap">
